...
public class GameController {
    ...
    private void initNewGame() {
        ...
        scene.setOnKeyPressed(ev -> {
            ...
            if (code == KeyCode.KP_LEFT || code == KeyCode.A) moved = board.moveLeft();
            else if (code == KeyCode.KP_RIGHT || code == KeyCode.D) moved = board.moveRight();
            else if (code == KeyCode.KP_UP || code == KeyCode.W) moved = board.moveUp();
            else if (code == KeyCode.KP_DOWN || code == KeyCode.S) moved = board.moveDown();
        ...
        view.getQuitButton().setOnAction(e -> onExitToMenu.run());
    }
